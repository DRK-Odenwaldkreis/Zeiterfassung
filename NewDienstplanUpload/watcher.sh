...
then
echo "Result is true"
year=$(find /home/webservice_testz/Planung/* -amin +239 -amin -299 | cut -d'/' -f5 | cut -d'_' -f2)
week=$(find /home/webservice_testz/Planung/* -amin +239 -amin -299 | cut -d'/' -f5 | cut -d'_' -f4 | cut -d'.' -f1)
echo $year
echo $week
