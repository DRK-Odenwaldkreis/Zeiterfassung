...
if __name__ == "__main__":
    try:
        ...
        sql = "SELECT Dienste.Personalnummer, Personal.Name FROM Dienste as Dienste JOIN Personal as Personal ON Personal.Personalnummer = Dienste.Personalnummer WHERE MONTH(Dienste.Dienstbeginn)=%s and YEAR(Dienste.Dienstbeginn)=%s and Personal.Hauptamtlich=0"%(requestedMonth,requestedYear)
        ...
        for i in personalnummer:
            ...
            personalNetShiftSums[i[0]] = [sum,i[1]]
        sumFilename = create_sum_CSV(personalNetShiftSums, requestedMonth, requestedYear)
